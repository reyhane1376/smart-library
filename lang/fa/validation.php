...
return [
    ...
    */
    ...
    'date_format' => 'گزینه «:attribute» با فرمت زمانی همخوانی ندارد',
    ...
    'required_if' => 'تکمیل گزینه «:attribute» الزامی می باشد',
    ...
    'uploaded' => 'آپلود «:attribute» با خطا مواجه شد. لطفا فرمت و حجم :attribute را کنترل فرمایید',
    ...
    */
    ...
    'attributes' => [
        ...
        'end_time'                 => 'زمان پایان',
        'about_me'                 => 'درباره من',
        'mobile2'                  => 'شماره موبایل پدر',
        'mobile3'                  => 'شماره موبایل مادر',
        ...
        'favicon_id'               => 'favicon',
        'reasonReject'             => 'علت رد',
        'payment_image_id'         => 'تصویر رسید',
        'sending_method'           => 'طریقه ارسال',
        'postal_Code'              => 'کدپستی',
        'question_count'           => 'تعداد سوالات',
        'correct_question_count'   => 'تعداد درست',
        'incorrect_question_count' => 'تعداد غلط',
        'negative_score_incorrect' => 'تعداد غلط در تنطیمات نمره منفی',
        'negative_score_correct'   => 'تعداد درست در تنطیمات نمره منفی',
    ],
];
